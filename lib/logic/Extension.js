...
class Extension extends BaseExtension {
  ...
  movePositionTo(position) {
    let currentPosition = Store.getConfig('position');
  ...
  setPositions() {
    ...
    const vertical =
      position === POSITION_TYPES.LEFT || position === POSITION_TYPES.RIGHT;
    ...
    const y =
      position === POSITION_TYPES.BOTTOM
        ? global.screen_height - widgetHeight
        : 0;
    ...
    Store.log(position, x, y, widgetWidth, widgetHeight, vertical);
